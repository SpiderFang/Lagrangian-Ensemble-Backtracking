...
> **閱讀提示**
> - 文件類型：教授與博士級計畫主持人使用的成果圖表與報告規格。
> - 它回答：條件式足跡、分母、時間、敏感度、收斂與失敗狀態應如何呈現。
> - 建議先讀：[科學方法與驗證](../foundation/03_scientific_method_and_validation.md)，再讀[實作狀態](../implementation_status.md)。
